...
class COGMENCollate(CollateBase):
    ...
    def __call__(self, samples):
        ...
        data = {
            ...
            "text_feature": torch.stack(text_feature) if 't' in self.modalities else None,
            "audio_feature": torch.stack(audio_feature) if 'a' in self.modalities else None,
            "visual_feature": torch.stack(visual_feature) if 'v' in self.modalities else None,
